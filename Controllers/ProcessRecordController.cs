...
public class ProcessRecordController : Controller
{
    ...
    public async Task<IActionResult> Create()
    {
        ...
        model.OpcUa = await _opcUaService.ReadStatusAsync();
        return View(model);
    }
    ...
    [HttpGet]
    public async Task<IActionResult> OpcUaStatus()
    {
        var status = await _opcUaService.ReadStatusAsync();
        return Json(status);
    }
    ...
    private static ProcessRecordEntity MapToEntity(ProcessRecordViewModel model)
    {
        return new ProcessRecordEntity
        {
            ...
            DoorOpenValue = model.OpcUa.DoorOpen,
            DoorOpenSourceTimestamp = model.OpcUa.DoorOpenSourceTimestamp,
            DoorClosedValue = model.OpcUa.DoorClosed,
            DoorClosedSourceTimestamp = model.OpcUa.DoorClosedSourceTimestamp,
    ...
    private static ProcessRecordViewModel MapToViewModel(ProcessRecordEntity entity)
    {
        return new ProcessRecordViewModel
        {
            ...
            OpcUa = new OpcUaStatusViewModel
            {
                DoorOpen = entity.DoorOpenValue,
                DoorOpenSourceTimestamp = entity.DoorOpenSourceTimestamp,
                DoorClosed = entity.DoorClosedValue,
                DoorClosedSourceTimestamp = entity.DoorClosedSourceTimestamp
            },
