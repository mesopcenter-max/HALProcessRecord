...
public sealed class OpcUaService : IDisposable
{
    ...
    public async Task<OpcUaStatusViewModel> ReadStatusAsync(CancellationToken cancellationToken = default)
    {
        var status = new OpcUaStatusViewModel
        {
            EndpointUrl = GetSetting("EndpointUrl", "opc.tcp://172.133.63.150:4840")
        };
        ...
        try
        {
            ...
            if (close.StatusCode != Opc.Ua.StatusCodes.Good || open.StatusCode != Opc.Ua.StatusCodes.Good)
            {
    ...
    private async Task EnsureConnectedAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var endpointUrl = GetSetting("EndpointUrl", "opc.tcp://172.133.63.150:4840");
            ...
            if (autoAccept)
            {
                ...
                {
                    e.Accept = e.Error.StatusCode == Opc.Ua.StatusCodes.BadCertificateUntrusted;
                };
            }
